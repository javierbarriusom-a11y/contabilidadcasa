...
test("views/inversion.js: renderInversionApalancamiento() repinta DEB12 al entrar en la vista — misma lección de LEV10 (vista cargada de forma perezosa, no pasa por renderAjustes()) — se coloca al final para no romper la adyacencia que otros tests ya fijan entre llamadas anteriores", () => {
