...
Candidato identificado para la próxima auditoría de producto, todavía sin formalizar en backlog: la
auditoría de copiloto/IA/fiscalidad/patrimonio/continuidad/multidispositivo iniciada en la sesión 164
(ver `PROJECT_STATE.md`, cierre de esa sesión) se abandonó sin convertirse en documento porque el hogar
priorizó activar `A5-1` — sus dos hallazgos de fiscalidad y continuidad siguen intactos hoy: el motor
fiscal (`canonical-tax-tables.js`, `canonical-irpf-estimator.js`) no cubre Impuesto sobre el Patrimonio
ni Sucesiones y Donaciones (el hogar dijo entonces "no aplica hoy, pero puede aplicar"), y la planificación
de continuidad no ha crecido más allá de las tres casillas manuales de `LPX3` (sesión 141). Copiloto e IA
y multidispositivo, en cambio, sí han avanzado desde entonces (`GOB17`, entre otras) y necesitarían
revisión antes de asumir que siguen "resueltos sin tarea nueva".
...
| --- | --- | --- | --- |
| **`BACKLOG_ULTIMATE_SEPTIEMBRE_OLEADA_4.md`** | ✅ Cerrada (sesión 191) — 46/46 tareas accionables construidas o reducidas/retiradas con motivo | Segunda auditoría crítica de producto sobre los mismos cuatro frentes de la Oleada 3, nacida de ["El Libro Vivo"](https://claude.ai/code/artifact/b30b9e52-c0fd-42d9-a993-2ef6625a40ad) (10 hallazgos + 49 propuestas), tras retirar 4 propuestas ya construidas en la Oleada 3 y reducir el alcance de otras 7 | Ninguno todavía — ver nota de sesión 192 arriba sobre el candidato sin formalizar (fiscalidad de patrimonio/sucesiones y continuidad) |
