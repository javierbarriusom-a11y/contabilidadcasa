...
**Estado (sesión 173, 12 de septiembre de 2026): `INV16` y `LEV14` construidas.** Bloque
...
`LEV11` (sesión 171); `PVC12` en sesión propia dedicada (sesión 172); `INV16` y `LEV14` (sesión 173) —
las dos únicas tareas del resto del backlog que ya venían con el alcance resuelto explícitamente por
el hogar (§10.5, sesión 171). Quedan 26 tareas accionables: las seis apuestas grandes (`INV11`,
`INV18`, `PVC14`, `GOB11`, `GOB15`, `GOB19`, todas reservadas a sesión propia) y el resto de los
Bloques 3-7.
