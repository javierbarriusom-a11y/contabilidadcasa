...
**Estado: 29/52 cerradas de la cola original, más `T20` (nacida y cerrada en la sesión 206, no
...
desbloqueada, con o sin decisión del hogar, queda agotada en esta sesión. **Condicionadas (decisión
previa o de terceros) que no dependían de `T14`:** `I9` (decidir dependencias UI), `I2`/`I3`
