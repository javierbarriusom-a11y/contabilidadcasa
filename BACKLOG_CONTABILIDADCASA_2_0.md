...
200-205). `T14` (Horizonte 3) arrancó en la sesión 206 (`views/escenarios.js`) y suma seis
...
`views/debt-control.js`, control de deuda) —
...
**siete incrementos construidos, sesiones 206-207**, tras que el hogar decidiera seguir con el patrón
