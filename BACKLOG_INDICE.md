...
| --- | --- | --- | --- |
| **[`BACKLOG_CONTABILIDADCASA_2_0.md`](BACKLOG_CONTABILIDADCASA_2_0.md)** | 🟢 Vigente — 9/52 cerradas (sesión 199: `D2`, `D3`, `D7`, `T1`, `T15`, `T17`, `T19`, `T2`, `D4` — `T1` añadió `T15`-`T19`) | Tercera auditoría crítica de producto («Contabilidadcasa 2.0», 10 hallazgos + 48 propuestas), en 4 bloques propios (`P-`/`I-`/`D-`/`T-`: previsión, inversión, deuda, transversales) tras descartar/reducir 3 propuestas por el cruce contra código real. Incorpora al final (§7) todo lo pendiente heredado de ciclos anteriores | Ninguno — es el backlog vigente |
