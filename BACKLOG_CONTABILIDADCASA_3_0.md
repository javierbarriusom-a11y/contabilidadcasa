...
| 3 — este semestre | ~~`FLU-2`~~ cerrada (23/09/2026, sesión 225); ~~`NAV-2`~~ cerrada (23/09/2026, sesión 226); ~~`FIN-1`~~ cerrada (23/09/2026, sesión 227); ~~`NAV-1`~~ cerrada (23/09/2026, sesión 228); ~~`FLU-1`~~ cerrada (23/09/2026, sesión 229); ~~`NAV-4`~~ cerrada (23/09/2026, sesión 230); ~~`ARQ-3`~~ cerrada (23/09/2026, sesión 231); ~~`ARQ-5`~~ cerrada (24/09/2026, sesión 237, caché offline completa — sin fila previa, entró por delante de todo por ser una función prometida rota); `ARQ-4` **en pausa** por decisión del hogar (sesión 237; dos incrementos publicados en las sesiones 233 y 236); queda `T9` (heredada) | Impacto directo en uso diario y deuda técnica, sin requerir motores nuevos ni depender de telemetría |
