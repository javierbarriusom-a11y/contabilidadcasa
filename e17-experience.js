(function attachE17Experience(root, factory) {
  ...
  const GUIDANCE = Object.freeze({
    ...
    "herramientas-patrimonio": ["Para qué sirve", "Analizar la cartera, priorizar qué vender, ver continuidad, independencia financiera, runway y resiliencia.", "Solo lectura, sin persistencia salvo lo ya guardado en Ajustes", "El patrimonio neto, los objetivos de reparto y las posiciones se editan en Ajustes → Patrimonio e inversión, no aquí."],
    "herramientas-analizar": ["Para qué sirve", "Comparar qué preveíamos frente a lo real, ver deriva por partida y navegar por qué es cada cifra.", "Solo lectura", "El autoajuste de la previsión y los umbrales se editan en Ajustes → Presupuesto y operación, no aquí."],
    "herramientas-datos": ["Para qué sirve", "Comprobar el simulacro de pérdida de acceso, compartir con un asesor externo y descargar informes.", "Genera enlaces y descargas, no persiste datos financieros", "El hogar compartido y la exportación de CSV/PDF/calendario se hacen en Ajustes → Datos y exportación."],
