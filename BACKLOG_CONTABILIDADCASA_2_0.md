...
200-205). `T14` (Horizonte 3) arrancó en la sesión 206 (`views/escenarios.js`) y suma un segundo
incremento en la 207 (`views/deuda.js`, comparador de estrategias) — ver su nota más abajo, sigue
pendiente el resto. El resto sigue pendiente — diagnóstico y planificación para lo que falta.
...
**dos incrementos construidos, sesiones 206-207**, tras que el hogar decidiera seguir con el patrón
