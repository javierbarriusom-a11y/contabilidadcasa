...
| 3 — este semestre | ~~`FLU-2`~~ cerrada (23/09/2026, sesión 225); ~~`NAV-2`~~ cerrada (23/09/2026, sesión 226); ~~`FIN-1`~~ cerrada (23/09/2026, sesión 227); ~~`NAV-1`~~ cerrada (23/09/2026, sesión 228); ~~`FLU-1`~~ cerrada (23/09/2026, sesión 229); ~~`NAV-4`~~ cerrada (23/09/2026, sesión 230); ~~`ARQ-3`~~ cerrada (23/09/2026, sesión 231); queda `ARQ-4` (continúa `T14`; primer incremento y techo de `app.js` el 24/09/2026, sesión 233; segundo incremento, «Nueva vida» simulación, sesión 236; tercero, Agente de ahorro + `canonical-savings-agent.js`, sesión 237 — queda Visual Detail)/`T9` (heredada) | Impacto directo en uso diario y deuda técnica, sin requerir motores nuevos ni depender de telemetría |
