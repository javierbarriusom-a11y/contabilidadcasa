...
**Estado: 27/52 cerradas de la cola original, más `T20` (nacida y cerrada en la sesión 206, no
...
`I12` y `T12` (esfuerzo S, beneficio Medio/Alto) — toda la cola desbloqueada sin decisión previa
pendiente que quedaba en Horizonte 3 tras la pausa de `T14`. **Condicionadas (decisión previa o de
terceros):** `T16`/`T18`
