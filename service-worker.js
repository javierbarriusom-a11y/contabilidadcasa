...
const SHELL_URLS = [
  ...
  // ARQ-5 (24 de septiembre de 2026): estos 30 motores se cargan al arrancar desde index.html pero
  // nunca se añadieron aquí — entraron con las Oleadas 3 y 4 y con PER, y la lista se mantenía a
  // mano sin nada que la comparase con index.html. Sin red faltaban en silencio (sin error de JS):
  // Hoy perdía la salud financiera, Previsión su resumen por periodo, Inversión/Seguros/Patrimonio
  // sus avisos. tests/arq5-cache-offline-completa.test.cjs impide que vuelva a pasar.
  "./canonical-renewal-advisor.js",
  "./canonical-ghost-expense-detector.js",
  "./canonical-scenario-schema.js",
  "./canonical-scenario-engine.js",
  "./canonical-period.js",
  "./canonical-debt-cancel-or-hold-synthesis.js",
  "./canonical-leverage-barrier.js",
  "./canonical-leverage-simulator.js",
  "./canonical-leverage-cross-comparator.js",
  ...
  "./canonical-dividend-tax.js",
  "./canonical-emergency-credit-line.js",
  "./canonical-loan-guarantees.js",
  "./canonical-tax-tables.js",
  "./canonical-irpf-estimator.js",
