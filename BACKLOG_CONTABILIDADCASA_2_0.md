...
200-205). `T14` (Horizonte 3) arrancó en la sesión 206 (`views/escenarios.js`) y suma dos
incrementos más en la 207 (`views/deuda.js`, comparador de estrategias; `views/debt-liquidation-
plan.js`, plan de deuda óptimo heredado) — ver su nota más abajo, sigue pendiente el resto. El
...
**tres incrementos construidos, sesiones 206-207**, tras que el hogar decidiera seguir con el patrón
