...
**Publicado**: pendiente de commit/push/PR — rama `claude/budget-merge-partida-sources` sobre
`main` (independiente del PR #115 de cierre de sesión, que solo toca documentación).
