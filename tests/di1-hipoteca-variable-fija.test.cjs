...
test("la calculadora vive en #deuda-apalancamiento (OPT-24: ya no es un ajuste, es una herramienta) con sus campos (los cuatro originales más el de APX5), botón y nota", () => {
