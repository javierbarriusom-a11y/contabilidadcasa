...
200-205). `T14` (Horizonte 3) arrancó en la sesión 206 (`views/escenarios.js`) y suma cuatro
...
`views/executive-advisor.js`, ejecutivo) — ver su nota más abajo, sigue pendiente el resto. El
...
**cinco incrementos construidos, sesiones 206-207**, tras que el hogar decidiera seguir con el patrón
