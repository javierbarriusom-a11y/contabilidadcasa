...
| 4 — coste medio, sin urgencia | `NAV-3`, `NAV-5`, `FLU-3`, ~~`FIN-2`~~ cerrada (24/09/2026, sesión 232, adelantada al horizonte 3 a petición del hogar), `PROC-1`, `PROC-2`; revisar `D1`/`D6`/`I3`/`I6`/`I13` (heredadas) según sus propias condiciones | Sin bloqueo externo, pero de menor urgencia que el horizonte 3 |
